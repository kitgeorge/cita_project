...
u_values = np.read_csv("../cache/basis_functions/u_values.csv", header=None).to_numpy()[:, 0]
u_prime_values = np.loadtxt("../cache/basis_functions/u_prime_values.csv", header=None).to_numpy()[:, 0]
d_values = np.loadtxt("../cache/basis_functions/d_values.csv", header=None).to_numpy()[:, 0]
